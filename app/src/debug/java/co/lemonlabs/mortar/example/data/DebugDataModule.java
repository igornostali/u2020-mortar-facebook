...
public final class DebugDataModule {
    ...
    @Provides
    @Singleton
    Downloader provideDownloader(IdlingDownloaderWrapper idlingWrapper) {
    ...
    @Provides
    @Singleton
    IdlingDownloaderWrapper provideIdlingDownloaderWrapper(MockRestAdapter mockRestAdapter, Application app,
    ...
    @Provides
    @Singleton
    Picasso providePicasso(IdlingDownloaderWrapper downloaderWrapper, Application app) {
